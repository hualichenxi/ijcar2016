...
create table train_feature_buy_merchant_location_3days(
...
create index idx_train_feature_buy_merchant_location_3days on train_feature_buy_merchant_location_3days(User_id,Location_id,Merchant_id);
...
create table test_feature_buy_merchant_location_3days(
select A.User_id,A.Location_id,A.Merchant_id,IFNULL(B.count,0) as User_Merchant_Location_count
from te_d_new as A left join tmp1 as B on 
A.User_id=B.User_id and A.Merchant_id=B.Merchant_id and A.Location_id=B.Location_id
);
create index idx_test_feature_buy_merchant_location_3days on test_feature_buy_merchant_location_3days(User_id,Location_id,Merchant_id);
