...
drop table tmp_xx;
drop table tmp_x;
create index idx_feature_train1_buy_merchant_3days on train_feature_buy_merchant_3days(User_id,Location_id,Merchant_id);
...
create table test_feature_buy_merchant_3days(
select A.User_id,A.Location_id,A.Merchant_id,IFNULL(B.count,0) 
